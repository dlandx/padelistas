                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('track.index') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price_1" type="text" class="form-control{{ $errors->has('price_1') ? ' is-invalid' : '' }}" name="price_1" value="{{ old('price_1') }}" autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price_2" type="text" class="form-control{{ $errors->has('price_2') ? ' is-invalid' : '' }}" name="price_2" value="{{ old('price_2') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price_3" type="text" class="form-control{{ $errors->has('price_3') ? ' is-invalid' : '' }}" name="price_3" value="{{ old('price_3') }}" autofocus>
