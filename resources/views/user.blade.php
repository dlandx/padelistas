...
<section>
    <div class="content-info">
        <div class="title-admin p-4 text-uppercase">
            <h2>Gestión de usuarios - {{ Auth::user()->club->name }}</h2>
        </div>

        <div class="mb-5">
            <p>Gestionar los usuarios de pádel nunca fue tan facil, en la siguiente tabla puedes ver un listado de los usuarios que nos siguen, es decir, los usuarios que les gusta nuestro club deportivo <b>{{ Auth::user()->club->name }}</b>.</p>

            <div class="main-step">
                <div class="alert alert-primary mt-3" role="alert">No dudes en añadir una nueva pista en la aplicación...</div>
                <a href="{{ route('user.create') }}" class="btn-club">
                    <button class="btn-club btn btn-outline-info  btn-lg">Crear un usuario</button>
                </a>
            </div>
        </div>
