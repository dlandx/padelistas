...
<section class="text-justify">
    <div class="title">
        <h2 class="blue text-uppercase font-title">Gestión de pistas del centro deportivo {{ Auth::user()->club->name }}</h2>
    </div>

    <div class="col-sm-12 col-md-11 m-auto">
        <div class="mb-5">
            <p>Gestionar las pistas de un club deportivo <b>nunca fue tan fácil</b>, con nuestro software podrás gestionar tu centro deportivo desde cualquier dispositivo (pc, tablet, móvil) de forma sencilla. En la siguiente tabla puedes ver un listado de las pistas que dispone el club deportivo <b>{{ Auth::user()->club->name }}</b> con una breve información, no obstante siempre podras ver más información de la misma.</p>

            <h3 class="font-title text-primary">Software ágil, rápido e intuitivo</h3>
            <p>Con <b>Padelistas</b> intentamos unifica toda las gestiones de tu club deportivo en un único programa que te permite realizar cualquier acción eficaz y de forma ágil en unos pocos clics.</p>
        </div>        
    
        <div class="dos-grid">
            <div class="alert alert-primary mt-3" role="alert">No dudes en <b>añadir una nueva pista</b> en la aplicación...</div>
            <a href="{{ route('track.create') }}" class="center">
                <button class="btn-club btn btn-outline-info btn-lg">Registrar pista deportiva</button>
            </a>
        </div>
