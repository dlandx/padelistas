            ...
            <div>
                <table class="table table-hover table-borderless">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row" class="text-right">Estado de la reserva</th>
                            <td>
            ...
            <div class="reserve-img center text-light text-center">      
                <div>
                    <div class="pb-5">
                        ...
                        <h2 class="text-uppercase"><a href="{{ $club_tracks->club->id }}">{{ $club_tracks->club->name }}</a></h2>
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.cancelled', [$show->id, 0]) }}">
                            <button type='submit' class="btn btn-outline-light btn-block" {{ $disabled }} disabled>Cancelar reserva</button>
                        </a>
                    </div>                    
                </div>
            </div>
