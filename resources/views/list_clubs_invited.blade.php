            ...
            @foreach ($clubs as $item)
                <div class="card-club">
                    ...
                    <div class="card-content card-info">
                        <p class="txt-left"><a href="{{ route('club.track', $item['id']) }}">{{ $item['name'] }}</a></p>
                        <p class="txt-right">{{ $item['address'] }}</p>
                    </div>
                    <div class="club-open">
                        L M X Y Z
                    </div>
